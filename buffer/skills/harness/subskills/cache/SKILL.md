...
- `../harness-domain-language/DOMAIN-AWARENESS.md` for terminology
- [CACHE_GUIDE.md](./CACHE_GUIDE.md) for the full cache strategy
...
- [CACHE_GUIDE.md](./CACHE_GUIDE.md) -- detailed cache strategy and the four layers
- [CACHE_METRICS.md](./CACHE_METRICS.md) -- metrics collection and provider notes
- `../harness-domain-language/DOMAIN-AWARENESS.md` -- domain terminology

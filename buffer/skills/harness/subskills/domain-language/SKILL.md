...
Before acting, follow the consumer contract in [DOMAIN-AWARENESS.md](./DOMAIN-AWARENESS.md) — read existing `CONTEXT.md`, `CONTEXT-MAP.md`, `UBIQUITOUS_LANGUAGE.md`, and relevant ADRs.
